...
public class ListPanel extends JPanel implements ActionListener {
    ...
    private JCheckBox customerStateCB = new JCheckBox();
    ...
    public ListPanel(RestaurantPanel rp, String type) {
        ...
        */
        ...
        customerNameTextField.setPreferredSize(new Dimension(PANELWIDTH/2,PANELHEIGHT/2));
        customerNameTextField.setMaximumSize(new Dimension(PANELWIDTH/2,PANELHEIGHT/2));
        customerNameTextField.setMinimumSize(new Dimension(0,0));
